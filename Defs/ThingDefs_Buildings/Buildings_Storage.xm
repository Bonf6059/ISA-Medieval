...
<Defs>
	...
	<!-- This should render the storage on top of the items, for a less laggy solution (items are listed in the storage but aren't on the map) you need C# -->
	
	<ThingDef Name="ISA_ShelfBase" ParentName="ShelfBase" Abstract="True">
		<altitudeLayer>BuildingAbove</altitudeLayer>
	</ThingDef>
	
	<!-- ==================== Storage Base ==================== -->
	<ThingDef Name="ISA_LumberStorageBase" ParentName="ISA_ShelfBase" Abstract="True">
...
<!--		<researchPrerequisites Inherit="false">
	...
	<ThingDef Name="ISA_BrickStorageBase" ParentName="ISA_ShelfBase" Abstract="True">
		<thingClass>Building_Storage</thingClass>
		<researchPrerequisites Inherit="false">
			<li>Stonecutting</li>
		</researchPrerequisites>  
